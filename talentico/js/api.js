...
// La autenticación y el guardado del token pertenecen a auth.js.

const API_URL = "https://dummyjson.com";

/**
 * Realiza una petición a la API de DummyJSON.
 *
...
async function apiFetch(endpoint, options = {}) {
  try {
    ...
    // Solo se envía Content-Type cuando se manda un body JSON.
