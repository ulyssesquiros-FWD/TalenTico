  ...
  accountForm.addEventListener('submit', async (event) => {
    ...
    if (accountForm.dataset.futureApi === 'register') {
      ...
      try {
        ...
        // Crear usuario candidato por defecto en db.json
        ...
        showMessage('Cuenta creada con éxito. Redirigiendo al portal...', 'success');
        
        // Todos los nuevos registrados son candidatos y van a user-view.html
        setTimeout(() => {
          window.location.href = `user-view.html?userId=${encodeURIComponent(newUser.id)}`;
        }, 1200);
